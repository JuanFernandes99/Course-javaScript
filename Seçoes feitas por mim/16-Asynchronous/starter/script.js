...
// // a call que é mais rapida é q a q fica
...
// //se é mais rapida que o timer, envia o call é uma funçao do promise.race
...
// //Portanto, é semelhante ao Promise.All no sentido de que ele também retorna uma matriz de todos os resultados, mas a diferença é essa promessa. todos entrarão em curto-circuito assim que uma promessa for rejeitada, exceto a promessa. allSettled, simplesmente nunca curto-circuite. Portanto, ele simplesmente retornará todos os resultados de todas as promessas.
...
// //Então, como sempre, Promessa. any leva em uma série de várias promessas e esta retornará a primeira promessa cumprida e simplesmente ignorará as promessas rejeitadas. Então, basicamente, prometa. any é muito semelhante a Promise. corrida com a diferença de que promessas rejeitadas são ignoradas. E assim, portanto, os resultados da Promessa. qualquer um será sempre uma promessa cumprida, a menos, é claro, que todos rejeitem,
// // Promise.any([
// //   Promise.resolve('Success'),
// //   Promise.reject('ERROR'),
// //   Promise.resolve('Another success'),
...
// const img = ['img/img-1.jpg', 'img/img-2.jpg', 'img/img-3.jpg'];
// console.log(img);
// const loadAll = async function (imgArr) {
...
// loadAll(img).then(city => console.log(`${city}`));
